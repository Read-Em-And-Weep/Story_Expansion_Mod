gods.CreateKeepsake({
    ...
    Keepsake = {
        ...
        signoffMax = "From {#AwardMaxFormat}Iphigenia{#Prev}{!Icons.ObjectiveSeparatorDark}To constantly sacrifice yourself is to lose all that is worth sacrificing.",
