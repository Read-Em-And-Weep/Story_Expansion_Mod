...
gods.CreateKeepsake({
    ...
    Keepsake = {
        ...
        signoffMax = "From {#AwardMaxFormat}Cassandra{#Prev}{!Icons.ObjectiveSeparatorDark}Though you know not what your future holds, you are certain of those who will be in it.",
