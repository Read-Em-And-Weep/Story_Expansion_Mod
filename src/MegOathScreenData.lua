ScreenData.StoryExpansionOathScreen = 
{
    Name = "StoryExpansionOathScreen",
	Components = {},
	BlockPause = true,
	...
	ComponentData =
	{
		...
		Background = 
		{
			Animation = "StoryExpansionOathScreenBackground",
            -- Need to make new animation so Nemesis becomes Meg (since Nemesis is baked into TradeScreenBackground)
			X = ScreenCenterX,
			Y = ScreenCenterY,
		},
		...
		TitleText = 
		{
			Text = "StoryExpansionOathScreen_Title",
			X = ScreenCenterX,
			Y = 100,
			TextArgs =
			{
		...
		SubtitleText = 
		{
			Text = "StoryExpansionOathScreen_Subtitle",
			X = ScreenCenterX,
			Y = 150,
			TextArgs =
			{
		...
		GiveHintText = 
		{
			Text = "StoryExpansionOathScreen_GiveHint",
			X = 540,
			Y = 365,
			TextArgs =
			{
		...
		GetHintText = 
		{
			Text = "StoryExpansionOathScreen_GetHint",
			X = 1050,
			Y = 365,
			TextArgs =
			{
