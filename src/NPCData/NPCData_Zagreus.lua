        ...
        StoryExpansionFreeingZagreusDialogue =
			{
				...
				{ 
					...
					Text = "Try another lie {#Emph} \"dear sister\"{#Prev}. I held Melinoë in my arms earlier today, and unless she had a rather {#Emph} miraculous {#Prev} growth spurt since then, you two are not the same." },
...
{ 
					...
					Text = "I... I vaguely remember something like that. So you truly are Melinoë? I missed that much? How long has it been? Where is everyone else?" },

							{UsePlayerSource = true,
					Portrait = "Portrait_Mel_Intense_01",
					PreLineAnim = "MelTalkBrooding01", PreLineAnimTarget = "Hero",
					PostLineAnim = "MelinoeIdleWeaponless", PostLineAnimTarget = "Hero",
					Text = "Chronos trapped the members of the House beyond the reach of everyone but me. I have already freed Mother, but we must escape now before the Titan discovers us."},
					{ 
						PreLineWait = 0.85,
					Portrait = "Portrait_ZagPresent_Defiant_01",
					Text = "Melinoë, let us make a stand now. If we free Father, Nyx, Thanatos, Meg and everyone else, we should be able to save our home."},	
							{UsePlayerSource = true,
					Portrait = "Portrait_Mel_Vulnerable_01",
					PreLineAnim = "MelTalkExplaining01", PreLineAnimTarget = "Hero",
					PostLineAnim = "MelinoeIdleWeaponless", PostLineAnimTarget = "Hero",
					Text = "The spell I used draws a member of the House into a shared dream, where I can free them. I fear I shall not be able to muster up this mystic sleep until I return to the Crossroads where Lord Hypnos resides."},
										{ 
					Portrait = "Portrait_ZagPresent_Empathetic_01",
										PreLineAnim = "Zagreus_Talk_Start",

					Text = "Better to live on and fight another day, I always say! Truthfully however, I did very little of that, and much more fighting my way through the Underworld until I stopped dying. I expect your journey was similar?"},

					{ 
					Portrait = "Portrait_Mel_Pleased_01",
					Text = "Yes, my quest has been filled with much of the same. Now, we must retreat before Chronos wakes and captures us both. Let me show you what my magick can accomplish.",
